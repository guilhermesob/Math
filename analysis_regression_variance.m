...
b = regress(y, X); % Estimar os coeficientes usando regressão linear
...
% Calcular o p-valor associado à estatística F
p_value = 1 - fcdf(F_statistic, 1, length(y) - 2);
